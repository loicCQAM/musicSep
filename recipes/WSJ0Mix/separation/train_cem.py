...
class Separation(sb.Brain):
    ...
    def save_results2(self):
        ...
        # Remove NaNs
        self.all_sdrs = self.all_sdrs[~np.isnan(self.all_sdrs)]
        self.all_vocals_sdrs = self.all_vocals_sdrs[~np.isnan(self.all_vocals_sdrs)]
        self.all_drums_sdrs = self.all_drums_sdrs[~np.isnan(self.all_drums_sdrs)]
        self.all_bass_sdrs = self.all_bass_sdrs[~np.isnan(self.all_bass_sdrs)]
        self.all_accompaniment_sdrs = self.all_accompaniment_sdrs[~np.isnan(self.all_accompaniment_sdrs)]
